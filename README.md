...
Hardware: ~344 ns for an Add at the modeled 250 MHz — every single time. The
tail *is* the story: software p99.9 is ~7× its p50 (cache misses, OS jitter),
hardware's p99.9 equals its p50. Determinism is what you're buying with an FPGA.
